...
class backlist{
	...
	function getModuleFrames($name){
		...
		$frames['group']['items']['firstgrouper']['title'] = '团长退款';
		...
		$frames['setting']['items']['area']['url'] = url('site/entry/area/',array('m'=>$name));
		$frames['setting']['items']['area']['title'] = '地区运费';
		$frames['setting']['items']['area']['actions'] = array();
		$frames['setting']['items']['area']['active'] = '';
		return $frames;
	}
}
?>