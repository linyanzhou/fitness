...
if (empty($op)) {
	...
	for ($i = 0; $i < $lacknum; $i++) {
			$lack = $lack - 1;
			$data = array('uniacid' => $_W['uniacid'], 'gnum' => 1, 'openid' => $head_imgs_array[$i], 'ptime' => '', //支付成功时间
			...
			'addressid' => 0, 'addname' => '虚拟', 'mobile' => '虚拟', 'address' => '虚拟', 'g_id' => $thistuan['goodsid'], 'tuan_id' => $thistuan['groupnumber'], 'is_tuan' => 1, 'tuan_first' => 0, 'starttime' => TIMESTAMP, 'createtime' => TIMESTAMP);
