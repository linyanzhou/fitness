<?php
		...
		$orders = pdo_fetchall("SELECT * FROM " . tablename('tg_order') . " WHERE uniacid ='{$_W['uniacid']}' and openid='{$_W['openid']}' and is_tuan = 1 and status in(1,2,3,4,6,7) order by ptime desc");
